    ...
    <>
        ...
        <button className='flex justify-center text-md w-2/6 bg-yellow-500 text-white px-4 py-2 border rounded-md hover:bg-gray-100 hover:border-yellow-500 hover:text-yellow-500'>Update</button>
    </form>
    </> 
    )
    }
